...
class HamburguesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hamburguesa" do
    assert_difference('Hamburguesa.count') do
      post hamburguesas_url, params: { hamburguesa: { descripcion: @hamburguesa.descripcion, imagen: @hamburguesa.imagen, nombre: @hamburguesa.nombre, precio: @hamburguesa.precio } }
    end
  ...
  test "should update hamburguesa" do
    patch hamburguesa_url(@hamburguesa), params: { hamburguesa: { descripcion: @hamburguesa.descripcion, imagen: @hamburguesa.imagen, nombre: @hamburguesa.nombre, precio: @hamburguesa.precio } }
